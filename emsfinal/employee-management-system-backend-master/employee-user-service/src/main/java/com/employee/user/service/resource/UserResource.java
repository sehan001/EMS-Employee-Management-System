...
public class UserResource {
	...
	public ResponseEntity<CommonApiResponse> updateUser(UserRegisterDto registerRequest) {
		...
		userDetailToUpdate.setDob(registerRequest.getDob());
		userDetailToUpdate.setHrname(registerRequest.getHrname());
		userDetailToUpdate.setEmphistory(registerRequest.getEmphistory());
		userDetailToUpdate.setOfficeaddress(registerRequest.getOfficeaddress());
		userDetailToUpdate.setDoj(registerRequest.getDoj());
		userDetailToUpdate.setEmphistory(registerRequest.getEmphistory());
		userDetailToUpdate.setProjname(registerRequest.getProjname());
		userDetailToUpdate.setProjcode(registerRequest.getProjcode());
		userDetailToUpdate.setProjcode(registerRequest.getProjcode());
		userDetailToUpdate.setRepmanager(registerRequest.getRepmanager());
		userDetailToUpdate.setEmpemail(registerRequest.getEmpemail());
		userDetailToUpdate.setStartdate(registerRequest.getStartdate());
		userDetailToUpdate.setEnddate(registerRequest.getEnddate());
