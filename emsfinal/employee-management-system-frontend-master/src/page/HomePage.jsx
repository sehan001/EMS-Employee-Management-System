      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8">
            ...
            <p>
            Our approach for managing personnel is made to make things go smoothly 
            for managers, employees, and administrators.Easy access to personal profiles, the ability
            to check schedules, leave management capabilities, and integrated communication channels 
            all help employees stay motivated and organised. Supervisors may monitor worker performance,
            guarantee efficient teamwork by allocating tasks and allocating resources wisely. Our solution
            contributes to organisational success and employee happiness by 
            improving efficiency, compliance, and worker productivity through automated workflows, 
            strong security measures, and data-driven insights.
            </p>
           {/* <p>
